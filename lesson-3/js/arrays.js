...
console.log(`the 2nd element of the 4th array in is${myArray[3][1]}.`);
...
output.textContent = `myArray has ${myArray.length} elemements inside of it.`;
...
let orig6 = "Toronto Maple Leafs, Chicago Black Hawks, Detroit RedWings, Boston Bruins, Montreal Canadiens, New York Rangers";
...
output.textContent = `The last element of the array is ${orig6Array[orig6Array.length - 1]}.`;  //or ${orig6Array.at(-1)}.`
...
numItems = orig6Array.unshift("Winnepeg Jets,Quebec Nordiques");
...
orig6Array.splice(3, 0, "Edmonton Oilers");
