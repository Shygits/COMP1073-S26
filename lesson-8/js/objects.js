...
let person = {
    ...
    bio: function () {
        alert(
            `The interests of ${this.name.firstName}, of age ${this.age}, of gender ${this.gender} are ${this.interest}.`
        );
    },
};
...
output.textContent = person.greetings();
...
person.getPropertyValue = function (key) {
