...
let url = `https://github.com/Shygits/COMP1073-S26.git/lesson12/${verse}.txt`;
...
//.then().then()...catch() is on line typically this was for notes
fetch(url)
...
if(!response.ok) {
    throw new ErrorEvent("Error Occured!");
}
